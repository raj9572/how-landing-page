     ...
     <div className="shadow-md shadow-gray-300 ">
            ...
            <h1 className="text-2xl font-bold text-pink-500 ">Houseof-Wisdom</h1>
             ...
             <div className=" md:block gap-3 hidden ">
                <div>
                <a href="#" className='mx-4 text-black font-semibold text-xl  hover:text-pink-500 cursor-pointer'>Home</a>
                 <a href="#" className='mx-4 text-black font-semibold text-xl  hover:text-pink-500 cursor-pointer'>About</a>
                 <a href="#" className='mx-4 text-black font-semibold text-xl  hover:text-pink-500 cursor-pointer'>Service</a>
              ...
              <div className='ml-4 flex gap-2  md:hidden flex'>
